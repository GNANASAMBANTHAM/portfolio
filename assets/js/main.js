(function ($) {
  ...
  function mainMenu() {
    // Add the new toggle icon
    $('.st-nav').append('<span class="st-munu-toggle"><i class="fa-solid fa-toggle-on"></i></span>');
    
    // Add dropdown toggle icon
    $('.menu-item-has-children').append('<span class="st-munu-dropdown-toggle"><i class="fa-solid fa-toggle-off"></i></span>');
  
    // Toggle navigation menu on click
    $('.st-munu-toggle').on('click', function () {
      const icon = $(this).find('i'); // Select the icon inside the toggle
      if (icon.hasClass('fa-toggle-on')) {
        icon.removeClass('fa-toggle-on').addClass('fa-toggle-off'); // Toggle to 'off' icon
      } else {
        icon.removeClass('fa-toggle-off').addClass('fa-toggle-on'); // Toggle to 'on' icon
      }
      $(this).siblings('.st-nav-list').slideToggle(); // Toggle the menu list
    });
  
    // Toggle dropdowns on click
    $('.st-munu-dropdown-toggle').on('click', function () {
      const icon = $(this).find('i'); // Select the icon inside the dropdown toggle
